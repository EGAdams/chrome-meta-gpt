...
PROMPT_TEMPLATE = Path(__file__).parent.joinpath(
    'golden_design_api_prompt.md').read_text()
FORMAT_EXAMPLE = Path(__file__).parent.joinpath(
    'format_example_for_design_api.md').read_text()
...
class WriteDesign(Action):
    ...
    async def run(self, context):
        ...
        # write design prompt to temp_design_prompt.md
        open("temp_design_prompt.md", "w").write(prompt)
